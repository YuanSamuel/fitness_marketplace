...
class Trainer {
  ...
  Trainer(
      {this.firstName, this.lastName, this.email, this.profileUrl, this.description, this.rating, this.trainingTypes, this.videoPrice, this.livePrice, this.oneOnOnePrice, this.reference***REMOVED***);
