...
class MartialMarket extends StatefulWidget {
***REMOVED***
  _MartialMarketState createState() => _MartialMarketState();
***REMOVED***

class _MartialMarketState extends State<MartialMarket> {
***REMOVED***
***REMOVED***
    return Padding(
...
***REMOVED***
  ***REMOVED***
  ...
  Widget makeTrainer({image, name, pay, category, videoCount, sessions, video, video2, description***REMOVED***) {
    return Hero(
      tag: name,
